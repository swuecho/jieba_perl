# This Makefile is for the Jieba extension to perl.
#
...
XSUBPPDIR = /home/hwu/perl5/lib/perl5/ExtUtils
XSUBPP = "$(XSUBPPDIR)$(DFSEP)xsubpp"
XSUBPPRUN = $(PERLRUN) $(XSUBPP)
XSPROTOARG = 
XSUBPPDEPS = /usr/share/perl/5.18/ExtUtils/typemap /home/hwu/perl5/lib/perl5/ExtUtils$(DFSEP)xsubpp
XSUBPPARGS = -typemap '/usr/share/perl/5.18/ExtUtils/typemap'
XSUBPP_EXTRA_ARGS =
...
# Jieba might depend on some other libraries:
# See ExtUtils::Liblist for details
#
EXTRALIBS = -ljieba -lstdc++
LDLOADLIBS = -ljieba -lstdc++ -lm
BSLOADLIBS = 
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Jieba.pm $(INST_MAN3DIR)/Jieba.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(LIB_EXT) *$(OBJ_EXT) \
	  *perl.core Jieba.base \
	  Jieba.bs Jieba.bso \
	  Jieba.c Jieba.def \
	  Jieba.exp Jieba.o \
	  Jieba_def.old MYMETA.json \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Jieba' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Jieba",' >> META_new.json
...
test_static :: subdirs-test_static $(MAP_TARGET)
	PERL_DL_NONLAZY=1 "/home/hwu/dev/Jieba/$(MAP_TARGET)" $(MAP_PERLINC) "-MExtUtils::Command::MM" "-MTest::Harness" "-e" "undef *Test::Harness::Switches; test_harness($(TEST_VERBOSE), '$(INST_LIB)', '$(INST_ARCHLIB)')" $(TEST_FILES)

testdb_static :: static pure_all $(MAP_TARGET)
	PERL_DL_NONLAZY=1 "/home/hwu/dev/Jieba/$(MAP_TARGET)" $(MAP_PERLINC) "-I$(INST_LIB)" "-I$(INST_ARCHLIB)" $(TEST_FILE)
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Jieba" VERSION="0.01">' > Jieba.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for blah blah blah</ABSTRACT>' >> Jieba.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Hao Wu &lt;echowuhao@gmail.com&gt;</AUTHOR>' >> Jieba.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> Jieba.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.18" />' >> Jieba.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Jieba.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Jieba.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Jieba.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Jieba.pm' 'blib/lib/Jieba.pm' \
	  'testlib.pl' '$(INST_LIB)/testlib.pl' 
